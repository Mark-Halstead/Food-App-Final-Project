...
function FoodDiary() {
    ...
    useEffect(() => {
        ...
        async function getDiaryEntry() {
            try {
                ...
                const response = await fetch(`https://plate-perfect-server.onrender.com/diary_entries/`, options)
    ...
    async function updateDiary(updateData) {
        try {
            ...
            const response = await fetch(`https://plate-perfect-server.onrender.com/diary_entries/${selectedDate}`, 
                options
            )
    ...
    const handleAddFood = async (meal, selectedItem) => {
        ...
        try {
            ...
            const response = await axios.post(`https://plate-perfect-server.onrender.com/diary_entries/${selectedDate}/foods/${meal}`, data, {
                headers:{
    ...
    async function handleDeleteFood(meal, productId) {
        try {
            const response = await fetch(`https://plate-perfect-server.onrender.com/diary_entries/${currentDiaryEntry._id}/foods/${meal}/${productId}`,
                {method:"DELETE"}
            )
