...
function MealPlan() {
    ...
    useEffect(() => {
        ...
        async function getMealPlans() {
            ...
            try {
                ...
                const response = await fetch(`https://plate-perfect-server.onrender.com/meal_plan_entries/${selectedClient._id}`, options);
    ...
    async function saveMealPlan() {
        try {
            ...
            const response = await fetch(`https://plate-perfect-server.onrender.com/meal_plan_entries/${selectedClient._id}`, 
                options
            )
            if (response.status === 200) {
                const data = await response.json()
