...
import { Profile, Overview, Plan, SharedLayout, Chat, NutritionistSharedLayout, Register, Login, FoodDiary, UserSignUpForm, GoalsForm } from './pages/index'
    ...
    <>
      <AuthProvider>
        <Routes>
          ...
          <Route path='user-form' element={<UserSignUpForm />} />
